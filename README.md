...
### Vercel (Recommended)
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/Hyreli/hyreli&env=DATABASE_URL,AUTH_SECRET,DISCORD_CLIENT_ID,DISCORD_CLIENT_SECRET,OWNER_DISCORD_ID,AUTH_URL&project-name=hyreli)
